        ...
        <div class="container py-5 position-relative">
            ...
            <div class="position-relative" style="padding-bottom: 60px;">
                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-lg-6">
                            <div class="position-relative">
                                <img src="{{ asset($featuredProject->image_url) }}" class="img-fluid rounded-3 shadow-lg"
                ...
                @else
                    <div class="row">
                        <div class="col-12">
                            <div class="p-4 rounded-3 shadow-lg text-center text-white">
                                <h4 class="mb-2">No featured project available</h4>
                                <p class="mb-0">Check the admin or seeders to add projects.</p>
                            </div>
                        </div>
                    </div>
                @endif
