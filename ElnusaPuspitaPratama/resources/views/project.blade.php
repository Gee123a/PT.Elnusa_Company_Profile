                        ...
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <div class="row align-items-center">
                                <div class="col-lg-6 mb-4 mb-lg-0">
                                    <!-- Gambar placeholder (nanti bisa diganti dengan gambar asli) -->
                                    <img src="https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=800" 
                                ...
                                <div class="col-lg-6">
                                    <div class="bg-white p-4 p-lg-5 rounded shadow">
                                        ...
                                        <h3 class="display-5 fw-bold mb-3">{{ $project->project_name }}</h3>
                                        ...
                                        <div class="row g-3 mb-4">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <strong>{{ $project->deadline ? $project->deadline->format('M Y') : 'Ongoing' }}</strong>
                                            </div>
                                            <div class="col-6">
                                                <i class="bi bi-building text-warning fs-4 d-block mb-1"></i>
                                                <small class="text-muted d-block">Client</small>
                                                <strong>{{ $project->client->nama ?? 'N/A' }}</strong>
                                            </div>
                                            <div class="col-6">
                                                <i class="bi bi-cash-stack text-warning fs-4 d-block mb-1"></i>
                                                <small class="text-muted d-block">Budget</small>
                                                <strong>Rp {{ number_format($project->budget / 1000000000, 1) }}B</strong>
                                            </div>
                                        </div>
                                        <a href="{{ route('project.show', $project->id) }}" class="btn btn-outline-dark btn-lg px-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title fw-bold mb-3">{{ $project->project_name }}</h5>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted d-block mt-1">
                                        <i class="bi bi-building me-1"></i> {{ $project->client->nama ?? 'N/A' }}
                                    </small>
                                    <small class="text-muted d-block mt-1">
                                        <i class="bi bi-cash-stack me-1"></i> Rp {{ number_format($project->budget / 1000000000, 1) }}B
                                    </small>
                                </div>
                                <a href="{{ route('project.show', $project->id) }}" class="btn btn-outline-dark w-100">
                                    View Details
                                </a>
                            </div>
                        </div>
